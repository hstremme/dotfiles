...
init_tmux_mode_indicator() {
  local -r \
    ...
    prefix_style=$(indicator_style "$prefix_mode_style_config" "bg=$overlay,fg=blue") \
    copy_style=$(indicator_style "$copy_mode_style_config" "bg=$overlay,fg=yellow") \
    sync_style=$(indicator_style "$sync_mode_style_config" "bg=$overlay,fg=red") \
    empty_style=$(indicator_style "$empty_mode_style_config" "bg=$overlay,fg=cyan")
